...
def get_graylog_data(time_period):
    ...
    try:
        ...
        username = "admin"
        password = "Salvat!On"  # Try with escaped special character
        ...
        if response.status_code != 200:
            ...
            return get_messages_from_inputs(graylog_url, headers)
...
def get_messages_from_inputs(graylog_url, headers):
